        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketsUid = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatTicket", x => new { x.SeatsId, x.TicketsUid });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatTicket_Tickets_TicketsUid",
                        column: x => x.TicketsUid,
                        principalTable: "Tickets",
                        principalColumn: "Uid",
                        onDelete: ReferentialAction.Cascade);
                });
